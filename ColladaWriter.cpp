...
void ColladaWriter::createNodeStringStream()
{
	...
	for (auto& i : nodes)
	{
		...
		else
		{
			...
			nodeStream << "\t\t\t" << R"(<node id=")" << name << R"(" name=")" << name << R"(" sid=")" << name << R"(" type="JOINT">)" << endl;
			nodeStream << "\t\t\t\t" << R"(<translate sid="translate">)" << tx << " " << ty << " " << tz << "</translate>" << endl;
			...
			nodeStream << "\t\t\t\t" << R"(<scale sid="scale">)" << bones.at(i).scale.x << " " << bones.at(i).scale.y << " " << bones.at(i).scale.z << R"(</scale>)" << endl;
		}
	}
...
void ColladaWriter::writeMesh()
{
	...
	outFile << "\t\t\t\t\t" << R"(<float_array id="MeshPositionArray" count=")" << vertices.size() * 3 << R"(">)" << endl;
	outFile << "\t\t\t\t\t" << positionString.str().c_str() << endl;
	outFile << "\t\t\t\t\t" << "</float_array>" << endl;
	outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
	outFile << "\t\t\t\t\t\t" << R"(<accessor source="#MeshPositionArray" count=")" << vertices.size() << R"(" stride="3">)" << endl;
	...
	outFile << "\t\t\t\t\t" << "</float_array>" << endl;
	outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
	outFile << "\t\t\t\t\t\t" << R"(<accessor source="#MeshNormalArray" count=")" << vertices.size() << R"(" stride="3">)" << endl;
	outFile << "\t\t\t\t\t\t" << R"(<param name="X" type="float"/>)" << endl;
	outFile << "\t\t\t\t\t\t" << R"(<param name="Y" type="float"/>)" << endl;
	outFile << "\t\t\t\t\t\t" << R"(<param name="Z" type="float"/>)" << endl;
	outFile << "\t\t\t\t\t\t" << "</accessor>" << endl;
	...
	outFile << "\t\t\t\t\t" << R"(<float_array id="MeshTextureArray" count=")" << vertices.size() * 2 << R"(">)" << endl;
	outFile << "\t\t\t\t\t" << textureString.str().c_str() << endl;
	outFile << "\t\t\t\t\t" << "</float_array>" << endl;
	outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
	outFile << "\t\t\t\t\t\t" << R"(<accessor source="#MeshTextureArray" count=")" << vertices.size() << R"(" stride="2">)" << endl;
	...
	outFile << "\t\t\t\t" << R"(<triangles count=")" << (int)indices.size() / 3 << R"(" material="DefaultMaterial">)" << endl;
...
void ColladaWriter::writeSkin()
{
	...
	outFile << "\t\t\t\t\t" << R"(<Name_array id="MeshSkinJointsArray" count=")" << boneIndices.size() << R"(">)" << endl;
	outFile << "\t\t\t\t\t" << jointString.str().c_str() << endl;
	outFile << "\t\t\t\t\t" << "</Name_array>" << endl;
	outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
	outFile << "\t\t\t\t\t\t" << R"(<accessor source="#MeshSkinJointsArray" count=")" << boneIndices.size() << R"(" stride="1">)" << endl;
	...
	outFile << "\t\t\t\t\t" << R"(<float_array id="MeshSkinBindPosesArray" count=")" << boneIndices.size() * 16 << R"(">)" << endl;
	outFile << "\t\t\t\t\t" << inverseMatrixString.str().c_str() << endl;
	outFile << "\t\t\t\t\t" << "</float_array>" << endl;
	outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
	outFile << "\t\t\t\t\t\t" << R"(<accessor source="#MeshSkinBindPosesArray" count=")" << boneIndices.size() << R"(" stride="16">)" << endl;
	...
	outFile << "\t\t\t\t\t" << R"(<float_array id="MeshSkinWeightsArray" count=")" << weightIndexCount << R"(">)" << endl;
	outFile << "\t\t\t\t\t" << weightString.str().c_str() << endl;
	outFile << "\t\t\t\t\t" << "</float_array>" << endl;
	outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
	outFile << "\t\t\t\t\t\t" << R"(<accessor source="#MeshSkinWeightsArray" count=")" << weightIndexCount << R"(" stride="1">)" << endl;
...
void ColladaWriter::writeAnimation()
{
	...
	for (auto& i : animation.bones)
	{
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(TranslationInputArray" count=")" << i.translation.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << translationInputStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(TranslationInputArray" count=")" << i.translation.size() << R"(">)" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<Name_array id=")" << i.name << R"(TranslationInterpolationArray" count=")" << i.translation.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << translationInterpolationStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</Name_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(TranslationInterpolationArray" count=")" << i.translation.size() << R"(">)" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(TranslationArray" count=")" << i.translation.size() * 3 << R"(">)" << endl;
		...
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor count=")" << i.translation.size() << R"(" stride="3" source="#)" << i.name << R"(TranslationArray">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="X" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="Y" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="Z" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<input semantic="INTERPOLATION" source="#)" << i.name << R"(TranslationInterpolation"/>)" << endl;
		outFile << "\t\t\t\t\t" << R"(<input semantic="OUTPUT" source="#)" << i.name << R"(Translation"/>)" << endl;
		outFile << "\t\t\t\t" << "</sampler>" << endl;
		outFile << "\t\t\t\t" << R"(<channel source="#)" << i.name << R"(TranslateSampler" target=")" << i.name << R"(/translate"/>)" << endl;
		outFile << "\t\t\t" << "</animation>" << endl;
		outFile << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(RotateXInputArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << rotationInputStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(RotateXInputArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="TIME" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<Name_array id=")" << i.name << R"(RotateXInterpolationArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << rotationInterpolationStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</Name_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(RotateXInterpolationArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="INTERPOLATION" type="Name"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(RotateXArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		...
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor count=")" << i.quaternion.size() << R"(" source="#)" << i.name << R"(RotateXArray">)" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<input semantic="INTERPOLATION" source="#)" << i.name << R"(RotateXInterpolation"/>)" << endl;
		outFile << "\t\t\t\t\t" << R"(<input semantic="OUTPUT" source="#)" << i.name << R"(RotateX"/>)" << endl;
		outFile << "\t\t\t\t" << "</sampler>" << endl;
		outFile << "\t\t\t\t" << R"(<channel source="#)" << i.name << R"(RotateXSampler" target=")" << i.name << R"(/rotateX.ANGLE"/>)" << endl;
		outFile << "\t\t\t" << "</animation>" << endl;
		outFile << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(RotateYInputArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << rotationInputStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(RotateYInputArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="TIME" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<Name_array id=")" << i.name << R"(RotateYInterpolationArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << rotationInterpolationStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</Name_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(RotateYInterpolationArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="INTERPOLATION" type="Name"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(RotateYArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		...
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor count=")" << i.quaternion.size() << R"(" source="#)" << i.name << R"(RotateYArray">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="ANGLE" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<input semantic="INTERPOLATION" source="#)" << i.name << R"(RotateYInterpolation"/>)" << endl;
		outFile << "\t\t\t\t\t" << R"(<input semantic="OUTPUT" source="#)" << i.name << R"(RotateY"/>)" << endl;
		outFile << "\t\t\t\t" << "</sampler>" << endl;
		outFile << "\t\t\t\t" << R"(<channel source="#)" << i.name << R"(RotateYSampler" target=")" << i.name << R"(/rotateY.ANGLE"/>)" << endl;
		outFile << "\t\t\t" << "</animation>" << endl;
		outFile << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(RotateZInputArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << rotationInputStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(RotateZInputArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="TIME" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<Name_array id=")" << i.name << R"(RotateZInterpolationArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << rotationInterpolationStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</Name_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(RotateZInterpolationArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="INTERPOLATION" type="Name"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(RotateZArray" count=")" << i.quaternion.size() << R"(">)" << endl;
		...
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor count=")" << i.quaternion.size() << R"(" source="#)" << i.name << R"(RotateZArray">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="ANGLE" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<input semantic="INTERPOLATION" source="#)" << i.name << R"(RotateZInterpolation"/>)" << endl;
		outFile << "\t\t\t\t\t" << R"(<input semantic="OUTPUT" source="#)" << i.name << R"(RotateZ"/>)" << endl;
		outFile << "\t\t\t\t" << "</sampler>" << endl;
		outFile << "\t\t\t\t" << R"(<channel source="#)" << i.name << R"(RotateZSampler" target=")" << i.name << R"(/rotateZ.ANGLE"/>)" << endl;
		outFile << "\t\t\t" << "</animation>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(ScaleInputArray" count=")" << i.scale.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << scaleInputStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(ScaleInputArray" count=")" << i.scale.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="TIME" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<Name_array id=")" << i.name << R"(ScaleInterpolationArray" count=")" << i.scale.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << scaleInterpolationStream.str().c_str() << endl;
		outFile << "\t\t\t\t\t" << "</Name_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor source="#)" << i.name << R"(ScaleInterpolationArray" count=")" << i.scale.size() << R"(">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="INTERPOLATION" type="Name"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		outFile << "\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t" << "</source>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<float_array id=")" << i.name << R"(ScaleArray" count=")" << i.scale.size() * 3 << R"(">)" << endl;
		...
		outFile << "\t\t\t\t\t" << "</float_array>" << endl;
		outFile << "\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t" << R"(<accessor count=")" << i.scale.size() << R"(" stride="3" source="#)" << i.name << R"(ScaleArray">)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="X" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="Y" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << R"(<param name="Z" type="float"/>)" << endl;
		outFile << "\t\t\t\t\t" << "</accessor>" << endl;
		...
		outFile << "\t\t\t\t\t" << R"(<input semantic="INTERPOLATION" source="#)" << i.name << R"(ScaleInterpolation"/>)" << endl;
		outFile << "\t\t\t\t\t" << R"(<input semantic="OUTPUT" source="#)" << i.name << R"(Scale"/>)" << endl;
		outFile << "\t\t\t\t" << "</sampler>" << endl;
		outFile << "\t\t\t\t" << R"(<channel source="#)" << i.name << R"(ScaleSampler" target=")" << i.name << R"(/scale"/>)" << endl;
		outFile << "\t\t\t" << "</animation>" << endl;
		outFile << endl;
	}
